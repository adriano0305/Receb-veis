...
function beforeSubmit(context) {
    ...
    if (Record.id == 158) {
        ...
        if (estado_provincia && endereco_email_retorno && no_registro_iva && razaoSocial) {
            ...
            var retorno = api.sendRequest(objSPE, 'SPE_JUNIX/1.0/');
            ...
            if (retorno.OK){
                ...
                log.debug({title: 'Erro', details: retorno.CampoErros[0].Campo});
                Record.setValue('custrecord_rsc_status_sub_junix', 'Preencha o campo ' + retorno.CampoErros[0].Campo);
            }            
        } else {
            log.audit({
