        ...
        for(var i = 0; i < count; i++){
            ...
            if (check ==  true) {
                jsonAtualizado.push({
                    ...
                    "curtoPrazo": page.getSublistValue({ sublistId: 'custpage_sublist', fieldId: 'custpage_valor_curto', line: i}),
                    "longoPrazo": page.getSublistValue({ sublistId: 'custpage_sublist', fieldId: 'custpage_valor_longo', line: i}),
                    "dataSegregacao": {
