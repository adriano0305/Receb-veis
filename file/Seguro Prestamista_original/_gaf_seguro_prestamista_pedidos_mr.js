        ...
        const map = (mapContext) => {
            ...
            try{
                ...
                pvRecord.setValue({
                    ...
                    // value: valuesArray["values"]["custrecord_gaf_seg_presta_subsidiaria.CUSTRECORD_GAF_PSP_DETALHES_ID_PROCE"].value
                    //custrecord_gaf_seg_presta_subsidiaria.CUSTRECORD_GAF_PSP_DETALHES_ID_PROCE
                })
                pvRecord.setValue({
                ...
                var pedidoCriado = pvRecord.save()
