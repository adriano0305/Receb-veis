...
function onRequest(ctx) {
    ...
    if (method == 'GET') {
        ...
        // try{
            ...
            var dataVigencia, month, inicioSegregacao;
            ...
            busca.run().each(function(result) {
                ...
                if (statusInstallment == 'Não pago') {
                    ...
                    log.emergency('dataApuracao', dataApuracao)
                    log.emergency('dataSeg', dataSeg)
                    ...
                    log.emergency('difDataSeg_DataVencInst', difDataSeg_DataVencInst)
