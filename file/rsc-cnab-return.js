 ...
 */
define([ 'N/search', 'N/runtime', './rsc-cnab-return-dao', 'N/format', 'N/url', 'N/record', 'N/file', '../lib/rsc-cnab-constant' ],
     ...
     */
    function( search, runtime, dao, format, url, record, file, _c )
    {
        /**
         * @function
         * @param layout
        ...
        function createNote( installment, recordId, userId, error, occurrence )
        {
            ...
            note.setValue({ fieldId: 'recordtype', value: 1393, ignoreFieldChange: true });
