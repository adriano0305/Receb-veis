...
define(["require", "exports", "N/ui/serverWidget", "N/record", "N/search", "N/log"], function (require, exports, UI, record_1, search_1, log_1) {
        ...
        if (ctx.request.method == 'GET') {
            ...
            for (var i = 0; i < qtLinhasPagas; i++) {
                ...
                if (statusLinhaPaga == "Pago") {
                    ...
                    var indiceName = faturaRecord.getSublistValue({
                        fieldId: 'custpage_rsc_indice',
                        sublistId: 'custpage_rsc_parcelas',
                        line: i
                    })
                    var searchIndiceName = search_1.default.create({
                    ...
                    var valorPagoAttLinha = getValorPagoAtt(new Date(dataPagamentoLinha), searchIndiceName[0].id, valorPagoLinha);
            ...
            var valorVendaAtt = getValorVendaAtt(faturaRecord.id);
            ...
            log_1.default.error('valorVendaAtt', valorVendaAtt);
            log_1.default.error('somaLinhasPagas', somaLinhasPagas)
            var dadosIndice = {
    ...
    var createFieldsIndice = function (newForm, dadosIndice) {
        ...
        newForm.addField({
            ...
            container: 'custpage_indice'
        }).defaultValue = dadosIndice.percentual;
        return newForm;
    };
    ...
    var getValorPagoAtt = function (dataVencimento, indiceID, valorPago) {
        ...
        var retorno = valorPago
        if(fatorDataAtual && fatorDatavencimento){
            retorno = Number(fatorDataAtual) / Number(fatorDatavencimento) * valorPago;
        }
        return retorno
    };
    var getValorVendaAtt = function (idPrincipal) {
        var soma = 0;
