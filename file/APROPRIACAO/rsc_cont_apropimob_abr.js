 ...
 */
define(['N/file', 'N/ui/serverWidget', 'N/query', 'N/record', 'N/task', 'N/ui/message', 'N/ui/dialog', 'N/format', 'N/runtime', './rsc_module_aprop_querys'],

    (file, widget, query, record, task, message, dialog, format, runtime, apropQuery) => {
        var joinsAll = [];
        var dividendoAll = [];
        var divisorAll = [];
        ...
        function getFatores(assistant, scriptContext){
            ...
            var sql = 'select substr(subsidiary.name,1,4) subsidiary, job.companyname projeto, ' +
            ...
            var fileObj = file.create({
                name: 'sql_apropriacao.txt',
                fileType: file.Type.PLAINTEXT,
                contents: JSON.stringify(sql),
                folder: 4083
            });        
   
            var id_file_obj = fileObj.save();
