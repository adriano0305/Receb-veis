        ...
        const map = (mapContext) => {
            try {
                ...
                var body = {
                    ...
                    numeroUnidade: searchResult.values['name'],
                    status: searchResult.values['custrecord_rsc_un_emp_status'].text
                    ...
                    //  areaTerraco: 0,
                    //  areaOutros: 0,
                    //  acessao: searchResult.values['custrecord_rsc_un_emp_acessao'],
                    //  codigoExterno: searchResult.values['custrecord_rsc_id_unidade_junix'],
                    //  codUnidade: 0,
                    //  tipoUnidade: "",
                    //  nomeEmpreendimento: searchResult.values['custrecord_rsc_un_emp_projeto'].text,
                    //  nomeBloco: searchResult.values['custrecord_rsc_un_emp_bloco'].text
                }
                ...
                var retorno = JSON.parse(api.sendRequest(body, 'STATUS_DA_UNIDADE_JUNIX/1.0/'));
