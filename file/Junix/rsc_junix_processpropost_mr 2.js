            ...
            const map = (mapContext) => {
                    ...
                    try {
                            ...
                            *  from Junix Feed record type */
                            ...
                            var body = {
                                //     tipoFiltro: "PROCESSADOS",
                                // registroProcesso.getValue('custrecord_rsc_numero_proposta')
                                    Codigo: 16077
                            };
                    ...
                    try {
                            ...
                            if (dadosRetorno.NumeroProposta > 0) {
                                    ...
                                    var fieldsInvoice = {
                                            ...
                                            "custbody_rsc_tipo_transacao_workflow": 22,
                                    ...
                                    if (faturas.length > 0) {
                                            for (let i = 0; i < faturas.length; i++) {
                                                ...
                                                //     }
                                                    ...
                                                    var francaoPrincipal = runtime.getCurrentScript().getParameter({name: 'custscript_rsc_fracao_principal'})
                                                    invoiceRecord.setSublistValue({
                                                        fieldId: 'item',
                                                        sublistId: 'item',
                                                        line: 0,
