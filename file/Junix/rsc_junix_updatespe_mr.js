    ...
    (search, runtime, record, api) => {
        ...
        const getInputData = (inputContext) => {
            return search.create({
                ...
                filters:
                    [
                        //  ["custrecord_rsc_atualizado_spe_junix","is","F"],
                        //  "AND",
                        // ["iselimination", "is", "F"],
                        ["internalid", "anyof", "158"]
                    ],
                columns:
                    [
                        search.createColumn({
        ...
        const map = (mapContext) => {
            try {
                ...
                if(address.getValue('custrecord_enl_city')){
                    ...
                    nomeCidade = cidade.getValue('name')
                    nomeEstado = cidade.getValue('custrecord_enl_citystate')
                }
                ...
                if (retorno.OK){
                    ...
                    subsidiary.setValue('custrecord_rsc_atualizado_spe_junix', true);
                    ...
                    subsidiary.setValue('custrecord_rsc_status_sub_junix', 'Preencha o campo ' + retorno.CampoErros[0].Campo);
                }
