    ...
    (search, record) => {
        ...
        const beforeSubmit = (context) => {
            ...
            if (context.oldRecord) {
                if (context.oldRecord.getValue('custentity_rsc_atualizado_emp_junix') == context.newRecord.getValue('custentity_rsc_atualizado_emp_junix')) {
                    if (context.type !== context.UserEventType.DELETE) {
                        context.newRecord.setValue('custentity_rsc_atualizado_emp_junix', false);
                        context.newRecord.setValue('custentity_rsc_id_empreendimento_junix', context.newRecord.id);
                    }
                }
            } else {
                context.newRecord.setValue('custentity_rsc_atualizado_emp_junix', false);
        ...
        const afterSubmit = (context) => {
            ...
            recorde.setValue('custentity_rsc_id_empreendimento_junix', context.newRecord.id);
            recorde.save()
