...
const validarVencimento2 = (dataParcela, dataJuros) => {
    log.audit('validarVencimento2', {dataParcela: dataParcela, dataJuros: dataJuros});
    ...
    var mlsDP = vencimentoDP.getTime();
    log.audit('DP', {partesDP: partesDP, vencimentoDP: vencimentoDP, mlsDP: mlsDP});

    const partesDJ = dataJuros.split("/");
    var vencimentoDJ = new Date(partesDJ[2], partesDJ[1] - 1, partesDJ[0]);
    var mlsDJ = vencimentoDJ.getTime();
    log.audit('DJ', {partesDJ: partesDJ, vencimentoDJ: vencimentoDJ, mlsDJ: mlsDJ});

    if (vencimentoDP > vencimentoDJ) {
        var dif = mlsDP - mlsDJ;

        var diasMora = parseInt(dif / dia);
...
//     var vencimentoDP = new Date(partesDP[2], partesDP[1] - 1, partesDP[0]);
//     log.audit('partesDP / vencimentoDP', {partesDP: partesDP, vencimentoDP: vencimentoDP});
...
//     var vencimentoDJ = new Date(partesDJ[2], partesDJ[1] - 1, partesDJ[0]);
//     log.audit('partesDJ / vencimentoDJ', {partesDJ: partesDJ, vencimentoDJ: vencimentoDJ});
...
//     if (vencimentoDP > vencimentoDJ) {
//         log.audit('vencimentoDP > vencimentoDJ', {vencimentoDP: vencimentoDP, vencimentoDJ: vencimentoDJ});
//         var tempo = Math.abs(vencimentoDP.getTime() - vencimentoDJ.getTime());
//         log.audit('tempo', tempo);

//         var diasMora = Math.ceil(tempo / (1000 * 3600 * 24));
//         log.audit('diasMora', diasMora);
