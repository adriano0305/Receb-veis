            ...
            if (proRata > 0) {
                ...
                switch(indice) {
                    case '1': 
                        ...
                        console.log(JSON.stringify({i: i, proRata: proRata}, {item: item, findItem: findItem, find_amount_item: find_amount_item}));
                    break;
                    case '2': 
                        ...
                        if (findItem != -1) {
                            ...
                            .setCurrentSublistValue('item', 'item', item)
                            .setCurrentSublistValue('item', 'quantity', itensAdicionais.quantity)
                            .setCurrentSublistValue('item', 'rate', (Number(proRata) + Number(find_amount_item)).toFixed(2))
                            .setCurrentSublistValue('item', 'amount', (Number(proRata) + Number(find_amount_item)).toFixed(2))
                            .commitLine('item');
                        } else {
                            loadParcela.selectNewLine('item')
                            .setCurrentSublistValue('item', 'item', item)
